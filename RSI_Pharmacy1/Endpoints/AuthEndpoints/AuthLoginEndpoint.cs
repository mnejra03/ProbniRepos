...
using static RSI_Pharmacy.Endpoints.Auth.AuthLoginEndpoint;

namespace RSI_Pharmacy.Endpoints.Auth
{
    [Route("auth")]
    public class AuthLoginEndpoint(RSI_PharmacyContext db, MyAuthService authService) : MyEndpointBaseAsync
