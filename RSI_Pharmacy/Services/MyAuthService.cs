...
namespace RSI_Pharmacy.Services
{
    public class MyAuthService
    {
        private readonly RSI_PharmacyContext _applicationDbContext;
        private readonly IHttpContextAccessor _httpContextAccessor;

        // Constructor with dependency injection
        public MyAuthService(RSI_PharmacyContext applicationDbContext, IHttpContextAccessor httpContextAccessor)
        {
